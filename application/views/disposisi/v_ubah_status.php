    ...
    <table class="table">
        <?php foreach ($dt_disposisi as $dt) { ?>
            ...
            <tr>
                ...
                <td>
                    <select class="form-control" name="status_disposisi_atasan">
                        <option value="1" <?= $dt['status_disposisi_atasan'] == 1 ? 'selected' : '' ?>>Selesai Dilaksanakan</option>
                        <option value="0" <?= $dt['status_disposisi_atasan'] == 0 ? 'selected' : '' ?>>Tidak Dilaksanakan</option>
                        <option value="2" <?= $dt['status_disposisi_atasan'] == 2 ? 'selected' : '' ?>>Dilaksanakan Melewati Deadline</option>
                    </select>
                </td>
            </tr>
            <tr>
