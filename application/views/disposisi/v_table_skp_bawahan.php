...
<ol class="breadcrumb bc-3" style="margin-top:-30px;">
    ...
    <li><a href="javascript:void(0)">Disposisi Bawahan</a></li>
</ol>
    ...
    <table id="table" class="display" cellspacing="0" width="100%">
        <thead>
            <tr>
                ...
                <th>Edit Status Pekerjaan (Bawahan)</th>
            </tr>
        </thead>
        <tbody>
        </tbody>
...
<script type="text/javascript">
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('c_disposisi/ajax_list_bawahan') ?>",
            "type": "POST",
            "data": function (d) {
                d.tahun = $('#tahun').val();
            }
    ...
    function ubah_status_bawahan(id) {
        var dialog = new BootstrapDialog({
            message: function () {
                var $message = $('<div></div>').load('c_disposisi/ubah_status_bawahan' + '/' + id);
                return $message;
            }
        });
        dialog.realize();
